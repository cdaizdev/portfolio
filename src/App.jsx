...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans antialiased">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-slate-900/80 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-8 text-sm font-medium text-slate-400">
            ...
            <a href="#stack" className="hover:text-white transition">Tecnologías</a>
          </nav>
          <div>
            <button className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-500 rounded-lg shadow-lg shadow-emerald-600/20 transition-all duration-200">
              Iniciar Sesión
            </button>
          </div>
        </div>
      ...
      <section id="features" className="py-16 bg-slate-950/50 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
